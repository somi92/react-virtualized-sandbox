...
export default function customCellRangeRenderer({
    cellCache,
    cellRenderer,
    ...
    for (let rowIndex = rowStartIndex; rowIndex <= rowStopIndex; rowIndex++) {
        ...
        for (
            ...
            // Avoid re-creating cells while scrolling. This can lead to the same cell being created 
            ...
            if (
                ...
                // This makes dynamic cell content difficult for users and would also lead to a heavier 
                // memory footprint.
            } else {
